...
<div class="face-one-intro">
    ...
    <h2 class="face-one-intro-desc">
        React Input Textarea 支持任意 placeholder
    </h2>
    <!-- MARKRUN-HTML
...
<div style="text-align:center;" >
    <a href="https://travis-ci.org/onface/input.react" style="text-decoration: none;" >
        <img alt="Build Status" src="https://api.travis-ci.org/onface/input.react.svg?branch=master" />
    </a>
    <a href="https://npmjs.org/package/input.react"  style="text-decoration: none;" >
        <img alt="NPM version" src="https://img.shields.io/npm/v/input.react.svg?style=flat" />
    </a>
    <a href="https://npmjs.org/package/input.react"  style="text-decoration: none;" >
        <img alt="NPM downloads" src="https://img.shields.io/npm/dm/input.react.svg?style=flat" />
    </a>
</div>


<a href="https://saucelabs.com/u/onface-input.react" >
    <img alt="Saucelabs Tests" style="display:block;margin-left:auto;margin-right:auto;" src="https://saucelabs.com/browser-matrix/onface-input.react.svg" >
</a>
